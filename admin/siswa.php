...
$query=mysqli_query($conn, "select * from akun_siswa");
$no=1;
?>
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-primary bg-dark navbar-dark">
    ...
    <div class="card-body">
        <a href="tambah_siswa.php" class="btn btn-primary mb-2">Tambah</a>
                <table id="datatablesSimple" class="table table-bordered">
                  ...
                  <?php while ($row = mysqli_fetch_assoc($query)) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="edit_akun_siswa.php?nis=<?php echo $row['nis']; ?>" class="btn btn-warning">Edit</a>
                        <a href="hapus_siswa.php?nama=<?php echo $row['nama']; ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                    <?php endwhile;?>
                  </tbody>
