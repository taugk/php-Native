...
$query=mysqli_query($conn, "select * from daftar where status='D' order by tgl_daftar desc");
$no=1;
?>
                  ...
                  <?php while ($row = mysqli_fetch_assoc($query)) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="hapus.php?id_daftar=<?php echo $row['id_daftar']; ?>" class="btn btn-danger">Hapus</a>
                      </td>
                    </tr>
                    <?php endwhile;?>
                  </tbody>
